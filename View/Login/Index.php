<?php
	...
	$requestString = substr($requestUrl, strlen('localhost'));
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="#">
                ...
                <a href="ForgotPassword.php"><small>Esqueceu sua senha?</small></a>
                <p class="text-muted text-center"><small>Não tem uma conta?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="Register.php">Criar nova Conta</a>
            </form>
